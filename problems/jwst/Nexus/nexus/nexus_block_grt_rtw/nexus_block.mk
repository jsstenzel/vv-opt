...
COMPILER_COMMAND_FILE     = nexus_block_comp.rsp
CMD_FILE                  = nexus_block.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
{$(START_DIR)\nexus_block_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nexus_block_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nexus_block_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\nexus_block_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
nexus_block_data.obj : "$(START_DIR)\nexus_block_grt_rtw\nexus_block_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\nexus_block_grt_rtw\nexus_block_data.cpp"


rtGetInf.obj : "$(START_DIR)\nexus_block_grt_rtw\rtGetInf.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\nexus_block_grt_rtw\rtGetInf.cpp"


rtGetNaN.obj : "$(START_DIR)\nexus_block_grt_rtw\rtGetNaN.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\nexus_block_grt_rtw\rtGetNaN.cpp"


rt_nonfinite.obj : "$(START_DIR)\nexus_block_grt_rtw\rt_nonfinite.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\nexus_block_grt_rtw\rt_nonfinite.cpp"
