function S=grwabroad_tor(f,Ro,dR,type,model,scale,htor,ctor);
%rwabroad_tor   broadband PSD of reaction wheel radial torques
%
%       S=grwabroad_tor(f,Ro,dR,type,model,scale,htor,ctor)
%
%       where,  S	is the Power Spectral Density of the
%                	HST RWA radial torque disturbance ((Nm)^2/Hz)
...
%  08Aug98 odeweck:   added model variable for reaction wheel chosen
...
[Ci,hi]=grwadist_tor(1,model,scale,htor,ctor);
