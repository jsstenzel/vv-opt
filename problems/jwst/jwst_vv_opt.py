...
if __name__ == '__main__':  
	...
	###Optimal Bayesian Experimental Design
		...
		bn_measure_likelihood_convergence(problem, "BN_3M_samples", doPrint=True)
	
	elif args.run == "OBED_test":
		#Load the GMM from file
		gmm = bn_load_gmm("BN_model_3121355_ncomp70.pkl")
		presampled_ylist = bn_load_y(problem, "BN_3M_samples.csv", doPrint=False, doDiagnostic=False)
